...
// Alt-ed characters
//#define DO_SQ2 RALT(KC_2) // ²
//#define DO_SQ3 RALT(KC_3) // ³
#define DO_LCBR RALT(KC_8) // {
#define DO_LBRC RALT(KC_5) // [
#define DO_RBRC RALT(KC_6) // ]
#define DO_RCBR RALT(KC_9) // }
#define DO_BSLS RALT(LSFT(KC_7)) // backslash
#define DO_AT   RALT(DO_L) // @
#define DO_EURO RALT(KC_E) // €
#define DO_TILD RALT(DO_N) // ~
#define DO_PIPE RALT(DO_7) // |
