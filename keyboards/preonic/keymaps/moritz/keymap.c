...
[_QWERTZ] = {
  ...
  {KC_TAB,  DO_Q,    DO_W,    DO_E,    DO_R,  DO_T,   DO_Z,  DO_U,   DO_I,    DO_O,    DO_P,    DO_UE},
  {KC_ESC,  DO_A,    DO_S,    DO_D,    DO_F,  DO_G,   DO_H,  DO_J,   DO_K,    DO_L,    DO_OE,   DO_AE},
  {KC_LSFT, DO_LESS, DO_Z,    DO_X,    DO_C,  DO_V,   DO_B,  DO_N,   DO_M,    DO_COMM, DO_DOT,  KC_ENT },
  {DO_CIRC, KC_LCTL, KC_LALT, KC_LGUI, LOWER, KC_SPC, KC_SPC, RAISE, DO_ACUT, DO_MINS, DO_PLUS, DO_HASH}
},
